...
The `build.rs` configuration ensures each generated header includes all dependencies required for self-contained compilation,
  including other mongoac headers needed for opaque-pointer types.
